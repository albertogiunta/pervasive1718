...
interface BoundaryDao {
    ...
    @SqlUpdate("INSERT INTO $TABLE_NAME($HEALTH_PARAMETER_ID, $UPPERBOUND, $LOWERBOUND, $LIGHT_WARNING_OFFSET, $STATUS, $ITS_GOOD, $MIN_AGE, $MAX_AGE) VALUES (:$HEALTH_PARAMETER_ID, :$UPPERBOUND, :$LOWERBOUND, :$LIGHT_WARNING_OFFSET, :$STATUS, :$ITS_GOOD, :$MIN_AGE, :$MAX_AGE)")

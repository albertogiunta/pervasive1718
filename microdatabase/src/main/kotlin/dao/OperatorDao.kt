...
interface OperatorDao {
    ...
    @SqlUpdate("INSERT INTO $TABLE_NAME($CF, $NAME, $SURNAME, $ROLE_ID, $IS_ACTIVE) VALUES (:$CF, :$NAME, :$SURNAME, :$ROLE_ID, :$IS_ACTIVE)")
    fun insertNewOperator(@Bind(CF) operatorCF: String,

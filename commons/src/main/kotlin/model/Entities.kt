...
data class Task @JvmOverloads constructor(var id: Int = 0, val sessionId: Int, val operatorCF: String, @KlaxonDate val startTime: Timestamp, @KlaxonDate var endTime: Timestamp? = null, val activityId: Int, var statusId: Int) {
